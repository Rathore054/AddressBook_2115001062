...
namespace BusinessLayer.Service
{
    public class UserBookBL : IUserBookBL
    {
        ...
        public UserBookBL(IUserBookRL userRepository, JWTToken jwtTokenService, IMapper mapper, EmailService emailService)
        {
        ...
        public bool ResetPassword(string token, string newPassword)
        {
            try
            {
                ...
                user.PasswordHash = PasswordHelp.HashPassword(newPassword);
